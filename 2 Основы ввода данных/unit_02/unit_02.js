...
function t10() {
  document.querySelector('.out-10').textContent = +input10.value * 10;
}
...
function t11() {
  document.querySelector('.out-11').textContent = +input11.value + 10;
}
...
function t12() {
  document.querySelector('.out-12').textContent = 'Hello ' + input12_1.value + ' ' + input12_2.value
}
...
function t13() {
  document.querySelector('.out-13').textContent = +input13_1.value + +input13_2.value;
}
...
function t16() {
  document.querySelector('.out-16').textContent = +input16_1.value + +input16_2.value;
}
...
function t17() {
  document.querySelector('.out-17').textContent = parseInt(input17.value)
...
function t18() {
  document.querySelector('.out-18').textContent = parseFloat(input18.value);
}
...
function t19() {
document.querySelector('.out-19').textContent = parseInt(+input19_1.value + +input19_2.value)
}
...
function t20() {
document.querySelector('.out-20').textContent = `Уважаемый ${userName.value}, ${lastName.value}, ваш возраст ${age.value}, по профессии вы ${work.value}`
}
