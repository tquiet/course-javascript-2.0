...
function f15() {
    let input1 = document.querySelector('.i-15');
    let textarea = document.querySelector('.t-15');
    let out15 = document.querySelector('.out-15');

    textarea.value = input1.value;
    out15.innerHTML = input1.value;
}   
