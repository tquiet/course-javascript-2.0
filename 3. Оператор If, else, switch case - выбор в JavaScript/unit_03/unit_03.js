...
function f1() {
    let inputNum = +document.querySelector('.i-1').value,
        outNum = document.querySelector('.out-1');
    if (inputNum == 4) {
        outNum.textContent = true;
    } else {
        outNum.textContent = false;
    }
}
...
function f2() {
    let outCompareNum = document.querySelector('.out-2');
    if (a21 > a22) {
        outCompareNum.textContent = a21;
    } else {
        outCompareNum.textContent = a22;
    }
}
...
function f3() {
    let outCompareNum = document.querySelector('.out-3');
    if (+input31.value > +input32.value) {
        outCompareNum.textContent = +input31.value;
    } else {
        outCompareNum.textContent = +input32.value;
    }
}
...
let = outCompareNum4 = document.querySelector('.out-4');

function f4() {
    let input4 = +document.querySelector('.i-4').value;
    if ((2020 - input4) >= 18) {
        outCompareNum4.textContent = 1;
    } else {
        outCompareNum4.textContent = 0;
    }
}
...
let = outCompareNum5 = document.querySelector('.out-5');

function f5() {
    let input5 = +document.querySelector('.i-5').value;
    if (input5 < 0) {
        outCompareNum5.textContent = 'm'
    } else if (input5 === 0) {
        outCompareNum5.textContent = 0;
    } else {
        outCompareNum5.textContent = 1;
    }
}
...
let outCompareNum6 = document.querySelector('.out-6');

function f6() {
    let input6 = +document.querySelector('.i-6').value;
    if (input6 % 2 === 0) {
        outCompareNum6.textContent = 'even'
    } else {
        outCompareNum6.textContent = 'odd'
    }
}
...
let outCompareNum7 = document.querySelector('.out-7');

function f7() {
    let x = +document.querySelector('.i-71').value,
        n = +document.querySelector('.i-72').value;
    outCompareNum7.textContent = x ** n;
    // outCompareNum7.textContent = Math.pow(x,n);
}
...
let outCompareNum8 = document.querySelector('.out-8');

function f8() {
    let selectNum = +document.querySelector('.s-8').value;
    switch (selectNum) {
        case 1:
            console.log('one');
            break;
...
let outCompareNum9 = document.querySelector('.out-9');

function f9() {
    let input9 = +document.querySelector('.i-9').value;
    if (input9 <= 32) {
        outCompareNum9.textContent = 1
    } else if (input9 >= 33 && input9 <= 43) {
        outCompareNum9.textContent = 2
    } else if (input9 >= 44 && input9 <= 64) {
        outCompareNum9.textContent = 3
    } else {
        outCompareNum9.textContent = 0
    }
...
let outCompareNum10 = document.querySelector('.out-10');

function f10() {
    let selectNum = +document.querySelector('.s-100').value;
    outCompareNum10.textContent = selectNum;
}
...
let outCompareNum11 = document.querySelector('.out-11');

function f11() {
    let selectNum = +document.querySelector('.s-110').value;
    outCompareNum11.textContent = selectNum;
}
...
function f13() {
    ...
    document.querySelector('.out-13').textContent = typeof (input13)
...
let outCompareNum14 = document.querySelector('.out-14');

function f14() {
    let num1 = +document.querySelector('.i-141').value;
    let num2 = +document.querySelector('.i-142').value;
    let symb = document.querySelector('.s-143').value;

    if (symb == '+') {
        outCompareNum14.textContent = num1 + num2;
    } else if (symb == '-') {
        outCompareNum14.textContent = num1 - num2;
    } else if (symb == '*') {
        outCompareNum14.textContent = num1 * num2;
        ...
        outCompareNum14.textContent = error;
    }
}
...
let outCompareNum15 = document.querySelector('.out-15');

function f15() {
    let val1 = +document.querySelector('.s-151').value;
    let val2 = +document.querySelector('.s-152').value;
    let compare = document.querySelector('.s-153').value;

    if (compare == '&&') {
        outCompareNum15.textContent = val1&&val2;
    } else if (compare == '||') {
        outCompareNum15.textContent = val1||val2;
    }else{
        outCompareNum15.textContent = 'error';
    }
}
